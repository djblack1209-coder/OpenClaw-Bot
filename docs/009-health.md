...
| HI-987 | `BUSINESS/COMPLIANCE` | 🟠 重要 | 商品与入口已闭环，实单待确认 | 保证金账户已真实显示 ¥100；7 档 JIYU 余额商品各导入 1 张既有兑换码并上架，公开页均可点击“立即购买”，充值中心已回填七档链接。未执行真实购买；首笔 ¥1 付款、自动发货、兑换到账仍需操作当时再次确认，并继续遵守平台商品规则。 |
