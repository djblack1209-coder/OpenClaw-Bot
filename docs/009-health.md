...
| HI-850 | SECURITY | Frist-API runtime.json 仍明文存储用户 fk-live Key；密码哈希已迁移，运行数据加密和数据库迁移仍待做 | 2026-05-04 |
| HI-853 | UX | Frist-API 无"忘记密码"功能，用户丢失密码后无法自助恢复 | 2026-05-03 |
