...
观察日期：2026-09-12（新闻归并）；其他运行事实仍标记为 2026-09-09。跨项目生产事实统一以 VPS-Config 的
`VPS-Config:docs/current/live-first-closure-v1.md` 为准；前缀表示该文件属于另一个工作区，本文件只保留本项目接管所需状态。
...
- Intel 最新旧调度证据为 2026-09-11：纽约 08:30 触发，因新加坡业务窗口已结束被阻止，`network_calls=0`。本次新闻归并及时间修复状态见 `docs/090-news-consolidation-2026-09-12.md`；新自然投递仍须以实际回执验收。
