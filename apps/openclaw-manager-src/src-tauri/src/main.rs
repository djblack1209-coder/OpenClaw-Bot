...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            clawbot_api::clawbot_api_social_browser_control,
            clawbot_api::clawbot_api_social_ops_workspace,
            clawbot_api::clawbot_api_social_persona_review,
            clawbot_api::clawbot_api_social_persona_review_update,
            clawbot_api::clawbot_api_social_review_pack,
            clawbot_api::clawbot_api_social_strategy_update,
            clawbot_api::clawbot_api_social_growth_feedback,
            clawbot_api::clawbot_api_social_growth_drafts,
