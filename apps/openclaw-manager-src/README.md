...
```bash
# 对 .app 文件执行
xattr -cr /Applications/OpenClaw\ Bot.app

# 或者对 .dmg 文件执行（安装前）
xattr -cr ~/Downloads/OpenClaw-Bot.dmg
```
...
- [OpenClaw Bot](https://github.com/miaoxworld/openclaw-manager) - 图形界面版本（本项目）
