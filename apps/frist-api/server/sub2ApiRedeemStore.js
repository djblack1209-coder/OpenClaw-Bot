...
export function createSub2ApiRedeemStore(options = {}) {
  if (options.xianyuRedeemStore) {
    return options.xianyuRedeemStore;
  }
  ...
  const pool = new Pool({
    ...
    application_name: 'frist-api-xianyu-fulfillment',
  });
