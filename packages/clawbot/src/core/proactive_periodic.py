    ...
    try:
        ...
        try:
            ...
            if portfolio_summary:
                context_parts.append(f"当前持仓: {portfolio_summary}")
        ...
        try:
            ...
            recent_closed = journal.get_closed_trades(days=1, limit=200)
            trade_count = len(open_trades) + len(recent_closed)
            if trade_count:
                context_parts.append(f"当前及近24小时交易: {trade_count} 笔")
        except Exception as e:
        ...
        try:
            ...
            if _hs:
                ...
                _admin = next(iter(ALLOWED_USER_IDS), 0)
