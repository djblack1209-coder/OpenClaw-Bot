    ...
    async def handle_help_callback(self, update, context):
        ...
        HELP_SECTIONS = {
            ...
            "social": (
                ...
                "/xdraft  X 草稿预览\n"
                "/xpost  兼容入口：生成 X 待审草稿\n"
                "/xhsdraft  小红书草稿预览\n"
                "/xhspost  兼容入口：生成小红书待审草稿\n"
                "/publish  素材参数预检，不直接外发\n"
                "/social_plan  查看发文计划\n"
                ...
                "/social_report  社媒报告\n"
                "/social_growth_feedback  增长复盘\n"
                "/social_growth_drafts  复盘生成待审草稿\n"
                "/social_review_drafts  查看待审草稿\n"
                "/social_review_approve <序号或ID>  确认草稿\n"
                "/social_review_reject <序号或ID>  打回草稿\n"
                "/social_review_schedule <序号或ID> 明天8点  加入排程\n"
                "/social_review_schedule_queue  查看待发布排程\n"
                "/social_review_final_confirm <序号或ID>  到点最终确认\n"
                "/topic <题材>  深度研究题材\n"
                "/xwatch  X 监控\n"
                "/xbrief  X 简报\n"
                "/xhs  小红书内容管理"
