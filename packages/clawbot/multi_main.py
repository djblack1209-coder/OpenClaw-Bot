...
_COMMON_COMMANDS = [
    ...
    BotCommand("social_strategy", "切换社媒运营打法"),
    BotCommand("social_growth_feedback", "社媒增长复盘"),
    BotCommand("social_growth_drafts", "复盘生成待审草稿"),
    BotCommand("social_review_drafts", "查看社媒待审草稿"),
    BotCommand("social_review_approve", "确认待审草稿"),
    BotCommand("social_review_reject", "打回待审草稿"),
    BotCommand("social_review_schedule", "草稿加入待发布排程"),
    BotCommand("social_review_schedule_queue", "查看社媒待发布排程"),
    BotCommand("social_review_final_confirm", "排程到点最终确认"),
